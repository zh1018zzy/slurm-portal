...
openssl genpkey -algorithm RSA -out "$PRIVATE_KEY_FILE" -pkcs8 -aes256 \
    -pass pass:hpc-license-private-key-2025
...
openssl rsa -pubout -in "$PRIVATE_KEY_FILE" -out "$PUBLIC_KEY_FILE" \
    -passin pass:hpc-license-private-key-2025
...
echo ""
echo "🔍 验证密钥对..."
echo "test-data" | openssl rsautl -sign -inkey "$PRIVATE_KEY_FILE" -passin pass:hpc-license-private-key-2025 | \
