...
### 控制台日志
```
API 返回的所有作业: [..., {jobId: "105", jobType: "graphics", vncUrl: "http://192.168.31.130:6080/vnc.html?host=vtdev&port=6001", ...}]
过滤后的 graphics 作业: [{jobId: "105", jobType: "graphics", vncUrl: "http://192.168.31.130:6080/vnc.html?host=vtdev&port=6001", ...}]
渲染作业: 105 {status: "RUNNING", jobType: "graphics", vncUrl: "http://192.168.31.130:6080/vnc.html?host=vtdev&port=6001", ...}
```
...
### 检查 VNC 服务
```bash
ssh vtdev "ps aux | grep Xvnc"
ssh vtdev "netstat -tlnp | grep 6001"
```
