...
```
[getJobStatus] 作业 105 生成VNC URL: http://192.168.1.10:6080/vnc.html?host=compute-node-01&port=6001
```
...
VNC信息:
  Display: :101
  Port: 6001
  Node: compute-node-01 (192.168.1.10)
  URL: http://192.168.1.10:6080/vnc.html?host=192.168.1.10&port=6001
```
