...
```json
{
  ...
  "data": {
    ...
    "parameters": {
      "inputFile": "/home/demo_user/my-jobs/job_1753701085694_9cf35ec43122/test_auth.gjf"
    }
  }
}
```
...
$ squeue -j 123
             JOBID PARTITION     NAME     USER ST       TIME  NODES NODELIST(REASON)
               123   compute test-aut demo_user PD       0:00      1 (PartitionConfig)
```

**验证要点：**
- ✅ 作业ID: 123 成功提交
- ✅ 用户: `demo_user` (正确，不再是root)
- ✅ 作业名称: `test-aut` (正确)
- ✅ 分区: `compute` (正确)
...
**目录结构：**
```bash
$ ls -la /home/demo_user/my-jobs/job_1753701085694_9cf35ec43122/
total 16
drwxr-xr-x  2 demo_user 2000 4096 Jul 28 19:11 .
drwx------ 11 demo_user 2000 4096 Jul 28 19:11 ..
-rwx------  1 demo_user 2000  256 Jul 28 19:11 job.sh
-rw-r--r--  1 demo_user 2000  248 Jul 28 19:11 test_auth.gjf
```
...
```json
{
  ...
  "partition": "compute",
  "extra": {
    "scriptPath": "/home/demo_user/my-jobs/job_1753701085694_9cf35ec43122/job.sh",
    "stdoutPath": "/home/demo_user/my-jobs/job_1753701085694_9cf35ec43122/slurm-123.out",
    "stderrPath": "/home/demo_user/my-jobs/job_1753701085694_9cf35ec43122/slurm-123.err"
  }
}
```
