...
```json
{
  ...
  "data": {
    ...
    "parameters": {
      "inputFile": "/home/sc_admin/my-jobs/job_1753700133205_ba7b03a12342/test_auth.gjf"
    }
  }
}
```
...
**目录结构：**
```bash
$ ls -la /home/sc_admin/my-jobs/job_1753700133205_ba7b03a12342/
total 12
drwxr-xr-x 2 sc_admin 2000 4096 Jul 28 18:55 .
drwx------ 7 sc_admin 2000 4096 Jul 28 18:55 ..
-rw-r--r-- 1 sc_admin 2000  248 Jul 28 18:55 test_auth.gjf
```
...
```json
{
  ...
  "user": "root", // 注意：这是Slurm显示的用户，实际文件属于sc_admin
  "status": "FAILED",
  "partition": "compute"
}
```
