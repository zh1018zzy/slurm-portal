...
- **修复**: 将硬编码的 `192.168.31.130` 替换为环境变量
...
| `NOVNC_GATEWAY` | noVNC网关地址 | `192.168.31.130` |
| `NOVNC_PORT` | noVNC网关端口 | `6080` |
| `DEFAULT_NODE_IP` | 默认节点IP地址 | `192.168.31.130` |
...
✅ 已配置的环境变量:
  SUPABASE_URL: http://192.168.31.130:8000 (Supabase URL)
